...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_points2.png}
        \caption{Point cloud.}
        \label{fig:recon_step_point}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_dense1.png}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_mesh1.png}
        \caption{Mesh.}
        \label{fig:recon_step_mesh}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_refine2.png}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_texture1.png}
        \caption{Point cloud.}
        \label{fig:recon_step_texture}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{doc/thesis/0_figures/models_quality/100_1/120_100_1_img1.png}
        \caption{Image.}
