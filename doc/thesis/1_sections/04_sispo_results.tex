...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth, angle=90]{doc/thesis/0_figures/procedural_terrain/Wild2.jpg}
        \caption{}
...
The \gls{jp2} quality levels presented in in the results are the quality levels as defined in the \gls{jp2} implementation used by OpenCV, i.e. ranging from zero to 1000.
